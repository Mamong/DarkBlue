...
extension CBUUID {
    ...
    static public let batteryServiceUUID              = CBUUID(string: "180F")
...
extension CBUUID {
    ...
    public var displayName : String {
        if let sn = standardName{
            return sn
        }else{
            return "0x" + uuidString
        }
    }
    ...
    public var standardName : String? {
        ...
        } else if self == CBUUID.batteryServiceUUID {
        ...
        //CBUUID details six predefined descriptors and their corresponding value types.
//        else if self == CBUUID(string: CBUUIDCharacteristicExtendedPropertiesString) {
//            return "Characteristic extended properties"
//        }else if self == CBUUID(string: CBUUIDCharacteristicUserDescriptionString) {
//            return "Characteristic user description"
//        }else if self == CBUUID(string: CBUUIDClientCharacteristicConfigurationString) {
//            return "Client characteristic configuration"
//        }else if self == CBUUID(string: CBUUIDServerCharacteristicConfigurationString) {
//            return "Server characteristic configuration"
//        }else if self == CBUUID(string: CBUUIDCharacteristicFormatString) {
//            return "Characteristic format"
//        }else if self == CBUUID(string: CBUUIDCharacteristicAggregateFormatString) {
//            return "Characteristic aggregate format"
//        }
        return nil
    }
